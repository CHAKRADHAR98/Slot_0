...
declare_id!("BZ21yPSaWuGgpwaHT9yAZ5KUoGjNZ5R2fFukhhcZQiKg");
pub mod constant;
pub mod error;
...
pub mod gather {
    ...
    // Deposit more SOL into bettor wallet
    pub fn deposit_bettor_wallet(ctx: Context<DepositBettorWallet>, amount_sol: u64) -> Result<()> {
        ctx.accounts.deposit(amount_sol)?;
        Ok(())
    }
